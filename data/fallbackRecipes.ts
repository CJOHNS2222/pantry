...
/**
 * Curated fallback recipes — exported as a module-level constant
 * so it is parsed once at load time instead of being re-allocated on every component render (PERF-004).
 */
export const FALLBACK_CSV_RECIPES: StructuredRecipe[] = [
    {
