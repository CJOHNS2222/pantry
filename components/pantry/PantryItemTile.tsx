...
import { Clock, ChefHat, Trash2, Plus } from 'lucide-react';
...
export const PantryItemTile: React.FC<PantryItemTileProps> = ({
  item,
  bulkMode,
  isSelected,
  onToggleSelect,
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-theme-primary">
        ...
        {/* Detail shortcut */}
        <button
          onClick={(e) => { e.stopPropagation(); onSelectItem(primaryIndex); }}
