...
export const CameraPermissionsModals: React.FC<CameraPermissionsModalsProps> = ({
  ...
  return (
    <>
      ...
      <Modal
        isOpen={showPermissionEducator}
        onClose={() => { setShowPermissionEducator(false); setPendingCameraAction(null); }}
        size="sm"
        hideCloseButton
      ...
      <Modal
        isOpen={showSettingsFallback}
        onClose={() => { setShowSettingsFallback(false); setPendingCameraAction(null); }}
        size="sm"
        hideCloseButton
        panelClassName="overflow-hidden"
      >
