...
export const ShoppingListAddFab: React.FC<ShoppingListAddFabProps> = ({ onOpenAddModal }) => {
  return (
    <button
      ...
      className="fixed bottom-28 right-6 z-20 bg-[var(--accent-color)] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
